...
(function(){
    ...
    (function() {
    var p = "2934174", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2934174||'',
    GUID:window.ftGUID_2934174||'99999999999',
    confID:window.ftConfID_2934174||'0',
    ftReturn: window.ftReturn_2934174||'',
    keyword:window.ftKeyword_2934174||'',
    ftId:window.ftId_2934174||'',
    imp:window.ftImp2934174,
    ftImpId:window.ftImp2934174 && window.ftImp2934174.impID || '',
    campaignID:'87548',
    cID:'68441',
    pID:'2934174',
    creativeID:'2099314',
    exttrack:[],
    extscript:["https://js.dmtry.com/antenna2.js?0_4062_212051087_2099314&amp;echo=[%FT_IMPRESSIONID%]_[FT_GUID][noCachebuster]","https://cdn.doubleverify.com/dvtp_src.js?ctx=1000798&cmp=87548&sid=9979&plc=2934174&num=&adid=&advid=1487&adsrv=29&region=30&btreg=/2934174/&btadsrv=flashtalking&crt=2099314&crtname=&chnl=&unit=&pid=&uid=&tagtype=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/87548;2934174;2099314;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://disneyworld.disney.go.com/special-offers/resident-discover/"],
    placementDescription:'DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking728x90NATPFLAMULNAPM9VRV',
    width:728,
    height:90,
    ...
    divID:'ftdiv2934174',
    phID:'ftpos2934174',
    frameID:'ftframe2934174',
    expID:'ftexpframe2934174',
    altImgID:'ftalt2934174',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/87548;2934174;2099314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://disneyworld.disney.go.com/special-offers/resident-discover/',
    altImg:'http://servedby.flashtalking.com/imp/8/87548;2934174;204;gif;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking728x90NATPFLAMULNAPM9VRV/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/87548;2934174;271;pixel;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking728x90NATPFLAMULNAPM9VRV/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/87548;2934174;207;guid;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking728x90NATPFLAMULNAPM9VRV/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/293/2934174/2099314/js/j-2934174-2099314.js',
    file:'http://cdn.flashtalking.com/68441/2099314/snowball_HTML5_728x90.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?101868881-2934174;2099314;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2934174||'',
    segmentList:window.ftSegmentList_2934174||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2934174 && window.ftImp2934174.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2934174')&&/^https:/.test(document.getElementById('ftscript_m2934174').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2934174'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2934174'],
        ['ftcfid', 'ftConfID_2934174'],
        ['fttime', 'ftTimestamp_2934174'],
        ['ftsection', 'ftSection_2934174'],
        ['ftcustom', 'ftCustom_2934174'],
        ['ft_id', 'ftId_2934174'],
        ['ftimpid','ftImp2934174', 'impID']
    ]
};
...
ft2934174.encodeClickCount = parseInt('1', 10) || 0;



ft2934174.addVClick = function(ct) {
