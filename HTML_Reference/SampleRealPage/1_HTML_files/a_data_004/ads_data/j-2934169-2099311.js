...
(function(){
    ...
    (function() {
    var p = "2934169", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2934169||'',
    GUID:window.ftGUID_2934169||'99999999999',
    confID:window.ftConfID_2934169||'0',
    ftReturn: window.ftReturn_2934169||'',
    keyword:window.ftKeyword_2934169||'',
    ftId:window.ftId_2934169||'',
    imp:window.ftImp2934169,
    ftImpId:window.ftImp2934169 && window.ftImp2934169.impID || '',
    campaignID:'87548',
    cID:'68441',
    pID:'2934169',
    creativeID:'2099311',
    exttrack:[],
    extscript:["https://js.dmtry.com/antenna2.js?0_4062_212051561_2099311&amp;echo=[%FT_IMPRESSIONID%]_[FT_GUID][noCachebuster]","https://cdn.doubleverify.com/dvtp_src.js?ctx=1000798&cmp=87548&sid=9979&plc=2934169&num=&adid=&advid=1487&adsrv=29&region=30&btreg=/2934169/&btadsrv=flashtalking&crt=2099311&crtname=&chnl=&unit=&pid=&uid=&tagtype=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/87548;2934169;2099311;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://disneyworld.disney.go.com/special-offers/resident-discover/"],
    placementDescription:'DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking160x600NATPFLAMULNAPM9VRT',
    width:160,
    height:600,
    ...
    divID:'ftdiv2934169',
    phID:'ftpos2934169',
    frameID:'ftframe2934169',
    expID:'ftexpframe2934169',
    altImgID:'ftalt2934169',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/87548;2934169;2099311;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://disneyworld.disney.go.com/special-offers/resident-discover/',
    altImg:'http://servedby.flashtalking.com/imp/8/87548;2934169;204;gif;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking160x600NATPFLAMULNAPM9VRT/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/87548;2934169;271;pixel;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking160x600NATPFLAMULNAPM9VRT/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/87548;2934169;207;guid;DoubleClickBidManager;DOUBLECLICKWDR630631FY18InspireFY18FloridaResidentDisplayGM4thPartyFlashtalking160x600NATPFLAMULNAPM9VRT/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/293/2934169/2099311/js/j-2934169-2099311.js',
    file:'http://cdn.flashtalking.com/68441/2099311/snowball_HTML5_160x600.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?101868849-2934169;2099311;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2934169||'',
    segmentList:window.ftSegmentList_2934169||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2934169 && window.ftImp2934169.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2934169')&&/^https:/.test(document.getElementById('ftscript_m2934169').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2934169'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2934169'],
        ['ftcfid', 'ftConfID_2934169'],
        ['fttime', 'ftTimestamp_2934169'],
        ['ftsection', 'ftSection_2934169'],
        ['ftcustom', 'ftCustom_2934169'],
        ['ft_id', 'ftId_2934169'],
        ['ftimpid','ftImp2934169', 'impID']
    ]
};
...
//5.0.3 min
(function(o) {
var ft_D9Tag=function(d,e,f,g,h){var a={cGuid:g,D9Settings:d||{},privacy:f,d9Callback:e,guid:"",d9TimeoutMS:parseInt(h,10)||0,d9Timeout:0,urlMod:"",lsGuid:function(){var a="";try{a="undefined"!==typeof localStorage&&localStorage.ftGUID?localStorage.ftGUID.replace(RegExp("[^A-F0-9]","g"),"").substr(0,14):""}catch(b){}return a}(),getGuid:function(){var c="",b=decodeURIComponent("%"+"5C");window.ft_GUID?c=window.ft_GUID:a.cGuid&&!RegExp("9{13}"+b+"d").test(a.cGuid)&&RegExp(b+"d{4}[0-9A-F]{10}").test(a.cGuid)?c=a.cGuid:a.lsGuid&&(c=a.lsGuid);return c},deployCallback:function(c){a.deployCallback=function(){};var b={};c?b=c:(b.guid=a.guid,b.d9ID=a.getD9Id(),b.urlMod=a.urlMod);a.d9Callback(null,b)},getD9Id:function(){return window.ft_d9ID||""},d9Response:function(c){var b="";clearTimeout(a.d9Timeout);try{b=c.DeviceID[0]}catch(k){}"timeout"!=b&&b?a.getD9Id()||(window.ft_d9ID=b||"",a.getD9Id()&&(a.d9Response=function(){})):a.urlMod+="&ftd9er=1&erMsg="+String(b);a.deployCallback()},init:function(){if(a.privacy&&"x"!==a.privacy)a.deployCallback({privacy:a.privacy});else{var c=a.getGuid();c&&(window.ft_GUID=c,a.guid=c);if(a.getD9Id())a.deployCallback();else{"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]);window.ftD9ResponseRegister.push(a);if(!window.D9r||window.D9r&&!window.D9r.callback){window.D9v={};D9v.UserID=a.guid||"99999999999999";for(var b in d)D9v[b]=d[b];window.D9r={};D9r.DeviceID=!0;D9r.callback=function(a){for(var b=0;b<window.ftD9ResponseRegister.length;b++)"function"==typeof window.ftD9ResponseRegister[b].d9Response&&window.ftD9ResponseRegister[b].d9Response(a)};window.D9scr=document.createElement("script");D9scr.type="text/javascript";D9scr.async=!0;D9scr.src="ht"+"tps://d9.flashtalking.com/d9core";window.D9=document.getElementsByTagName("script")[0];D9.parentNode.insertBefore(D9scr,D9)}0<a.d9TimeoutMS&&(a.d9Timeout=setTimeout(function(){a.d9Response({DeviceID:["timeout"]})},a.d9TimeoutMS))}}}};a.init()};
var mobO="1",deploy="1"===mobO||"2"===mobO&&RegExp("^.*(?:iPhone|iPad|iPod|Android|Windows"+decodeURIComponent("%"+"5C")+"sPhone|BlackBerry).*"+decodeURIComponent("%"+"24")).test(navigator.userAgent),execD9=function(){ft_D9Tag({TAG:"1",CampID:"3175",CCampID:o.campaignID},function(c,b){b||(b={});var a=b.d9ID?"ft_data=d9:"+b.d9ID+"&":"";o.ftImpId&&a&&(a="http://servedby.flashtalking.com/state/"+o.pID+";"+o.creativeID+";"+o.confID+";401;"+o.ftImpId+"/?"+a+"cachebuster=[RANDOM]",a=o.secure?a.replace(/^http:/,"https:"):a,(new Image).src=o.replaceMacros(a))},window["ftImp"+o.pID]&&window["ftImp"+o.pID].privacy,o.GUID||o.guid||"")},init=function(){deploy&&(o.expand?o.addEventListener("end",execD9):execD9())}();
}(ft2934169));
/* jshint ignore:end */
...
ft2934169.encodeClickCount = parseInt('1', 10) || 0;



ft2934169.addVClick = function(ct) {
